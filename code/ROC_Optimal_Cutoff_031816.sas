...
/* %if %sysevalf(&sysver >= 8.2) %then %do;*/ * Removed KL 3/18/16 KL;

%let stopme = 1; * Added to skip version check - KL 3/18/16 - KL;
 %if &stopme = 0 %then %do; * Added to skip version check - KL 3/18/16 - KL;
